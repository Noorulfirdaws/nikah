      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-14 space-y-16">
        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-gray-600 leading-relaxed">
            At Nikah, your work directly helps Muslims around the world find righteous spouses and build halal families. We're a remote-first, Muslim-founded company with a culture of purpose, prayer, and productivity.
          </p>
        </div>
              ...
              >
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    {job.highlight && (
                      <span className="text-xs font-bold px-2 py-0.5 rounded-full" style={{ background: 'rgba(26,107,74,0.1)', color: '#1a6b4a' }}>
                        Featured
                      </span>
                    )}
                ...
                <button
                  className="mt-3 sm:mt-0 px-5 py-2 rounded-xl text-sm font-medium transition-all hover:shadow-sm"
        ...
        <div className="text-center p-8 rounded-3xl" style={{ background: 'rgba(26,107,74,0.06)' }}>
          ...
          <p className="text-gray-500 text-sm mb-4">Send us a general application. If you share our mission and have skills we need, we'd love to hear from you.</p>
          <Link to="/contact" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl text-sm font-semibold text-white transition-all hover:opacity-90" style={{ background: 'linear-gradient(135deg, #1a6b4a, #2d9b6f)' }}>
            Get in touch
          </Link>
        </div>
      </div>
